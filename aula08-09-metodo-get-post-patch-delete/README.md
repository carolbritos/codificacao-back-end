...
PATCH
DELETE
Na Aula 08 foram criadas as rotas e os DTOs para gerenciamento de convidados. Na Aula 09 foi implementada a camada de serviço responsável pela manipulação dos dados e pelo tratamento de erros.
...
NPM
Criação do projeto
O projeto foi criado utilizando o Nest CLI:
